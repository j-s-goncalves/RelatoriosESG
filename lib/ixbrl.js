...
const CONCEPT_MAP = {
  ...
  // ── B1 — Opção A/B ────────────────────────────────────────────────────────
  "B1_PERIOD_METRICS::meta::selected_module": { concept: "ReportingModuleSelected", ctx: CTX_DURATION, numeric: false },
  "B1_PERIOD_METRICS::meta::reporting_basis": { concept: "ReportingBasis",          ctx: CTX_DURATION, numeric: false },

  // ── B3 — Energia ──────────────────────────────────────────────────────────
  "B3_ENERGY::value":                                  { concept: "TotalEnergyConsumptionMWh",          unitRef: "u_MWh", decimals: "2", ctx: CTX_DURATION, numeric: true },
  "B3_ENERGY_BREAKDOWN::elec::renewable_mwh":          { concept: "ElectricityRenewableMWh",            unitRef: "u_MWh", decimals: "2", ctx: CTX_DURATION, numeric: true },
  "B3_ENERGY_BREAKDOWN::elec::nonrenewable_mwh":       { concept: "ElectricityNonRenewableMWh",         unitRef: "u_MWh", decimals: "2", ctx: CTX_DURATION, numeric: true },
  "B3_ENERGY_BREAKDOWN::elec::total_mwh":              { concept: "ElectricityTotalMWh",                unitRef: "u_MWh", decimals: "2", ctx: CTX_DURATION, numeric: true },
  "B3_ENERGY_BREAKDOWN::fuels::renewable_mwh":         { concept: "FuelsRenewableMWh",                 unitRef: "u_MWh", decimals: "2", ctx: CTX_DURATION, numeric: true },
  "B3_ENERGY_BREAKDOWN::fuels::nonrenewable_mwh":      { concept: "FuelsNonRenewableMWh",              unitRef: "u_MWh", decimals: "2", ctx: CTX_DURATION, numeric: true },
  "B3_ENERGY_BREAKDOWN::fuels::total_mwh":             { concept: "FuelsTotalMWh",                     unitRef: "u_MWh", decimals: "2", ctx: CTX_DURATION, numeric: true },
  ...
  // ── B7 — Totais de resíduos ───────────────────────────────────────────────
  "B7_WASTE_TOTALS::hazardous::mass_ton":    { concept: "HazardousWasteTotalMassTon",        unitRef: null, decimals: "2", ctx: CTX_DURATION, numeric: true },
  "B7_WASTE_TOTALS::nonhazardous::mass_ton": { concept: "NonHazardousWasteTotalMassTon",     unitRef: null, decimals: "2", ctx: CTX_DURATION, numeric: true },
  "B7_WASTE_TOTALS::all::mass_ton":          { concept: "AllWasteTotalMassTon",              unitRef: null, decimals: "2", ctx: CTX_DURATION, numeric: true },
  "B7_WASTE_TOTALS::hazardous::vol_m3":      { concept: "HazardousWasteTotalVolumeM3",       unitRef: "u_m3", decimals: "2", ctx: CTX_DURATION, numeric: true },
  "B7_WASTE_TOTALS::nonhazardous::vol_m3":   { concept: "NonHazardousWasteTotalVolumeM3",   unitRef: "u_m3", decimals: "2", ctx: CTX_DURATION, numeric: true },
  "B7_WASTE_TOTALS::all::vol_m3":            { concept: "AllWasteTotalVolumeM3",             unitRef: "u_m3", decimals: "2", ctx: CTX_DURATION, numeric: true },
  ...
  // ── B8 — Género e países ──────────────────────────────────────────────────────
  "B8_GENDER::men::headcount":   { concept: "NumberOfMaleEmployees",   unitRef: null, decimals: "0", ctx: CTX_INSTANT, numeric: true },
  "B8_GENDER::women::headcount": { concept: "NumberOfFemaleEmployees", unitRef: null, decimals: "0", ctx: CTX_INSTANT, numeric: true },

  // ── B9 — Acidentes ──────────────────────────────────────────────────────────
  "B9_SAFETY::fatalities::employees":          { concept: "WorkRelatedFatalitiesEmployees",         unitRef: null, decimals: "0", ctx: CTX_DURATION, numeric: true },
  "B9_SAFETY::serious_injuries::employees":    { concept: "SeriousWorkRelatedInjuriesEmployees",    unitRef: null, decimals: "0", ctx: CTX_DURATION, numeric: true },
  "B9_SAFETY::recordable_injuries::employees": { concept: "RecordableWorkRelatedInjuriesEmployees", unitRef: null, decimals: "0", ctx: CTX_DURATION, numeric: true },
  "B9_SAFETY::days_lost::employees":           { concept: "DaysLostDueToWorkRelatedInjuries",       unitRef: null, decimals: "0", ctx: CTX_DURATION, numeric: true },

  // ── B9 — Diversidade (informação adicional) ────────────────────────────────
  ...
  // ── B10 — Remuneração ────────────────────────────────────────────────────────
  "B10_REMUNERATION::men::median_annual_eur":   { concept: "MedianAnnualRemunerationMenEUR",   unitRef: "u_EUR", decimals: "2", ctx: CTX_DURATION, numeric: true },
  "B10_REMUNERATION::women::median_annual_eur": { concept: "MedianAnnualRemunerationWomenEUR", unitRef: "u_EUR", decimals: "2", ctx: CTX_DURATION, numeric: true },

  // ── B10 — Condições de emprego ───────────────────────────────────────────────
  "B10_CONDITIONS::min_wage_eur":             { concept: "MinimumApplicableWageEUR",            unitRef: "u_EUR", decimals: "2", ctx: CTX_DURATION, numeric: true },
  "B10_CONDITIONS::pct_collective_agreement": { concept: "PctEmployeesCoveredByCollectiveBargaining", unitRef: "u_pct", decimals: "2", ctx: CTX_DURATION, numeric: true },
  "B10_CONDITIONS::avg_training_hours":       { concept: "AverageTrainingHoursPerEmployeePerYear",    unitRef: null,    decimals: "1", ctx: CTX_DURATION, numeric: true },

  // ── C5 — Rotatividade ─────────────────────────────────────────────────────────
  "C5_TURNOVER::hires::headcount":      { concept: "NumberOfNewHiresDuringPeriod",   unitRef: null, decimals: "0", ctx: CTX_DURATION, numeric: true },
  "C5_TURNOVER::departures::headcount": { concept: "NumberOfDeparturesDuringPeriod", unitRef: null, decimals: "0", ctx: CTX_DURATION, numeric: true },
...
function renderStructuredTableIx(code, definition, content) {
  ...
  // Meta fields
  const metaLines = (definition.meta_fields ?? []).map((field) => {
    const rawVal = content.meta?.[field.field_code] ?? null;
    return `    <p><strong>${esc(field.label)}:</strong> ${maybeWrap(code, `meta::${field.field_code}`, rawVal)}</p>`;
  }).join("\n");
  ...
  const bodyRows = rows.map((row) => {
    const dataCells = cols.map((col) => {
      if (col.computed) {
        ...
        return `<td>${maybeWrap(code, `${row.row_code}::${col.col_code}`, val)}</td>`;
      }
  ...
  const table = `    <table border="1" cellpadding="4" cellspacing="0">
